...
namespace Pencil.Gaming.Audio {
    internal static class Al32 {
        ...
        [DllImport(Al32.lib, CallingConvention = Al32.cconv)]
        ...
        [DllImport(Al32.lib, CallingConvention = Al32.cconv, EntryPoint = "alGenSources")]
        ...
        [DllImport(Al32.lib, CallingConvention = Al32.cconv, EntryPoint = "alDeleteSources")]
        ...
        [DllImport(Al32.lib, CallingConvention = Al32.cconv, EntryPoint = "alGenBuffers")]
        ...
        [DllImport(Al32.lib, CallingConvention = Al32.cconv, EntryPoint = "alDeleteBuffers")]
